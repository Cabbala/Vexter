...
| Measurement window | 2026-03-20T22:42:23.102Z -> 2026-03-20T22:44:53.527477Z | 2026-03-20T22:42:23.102Z -> 2026-03-20T22:44:53.527477Z |  |
| Config snapshot | config/dexter-resume-after-pr8-20260321T0743.config.json | config/mewx-resume-after-pr8-20260321T0743.config.json |  |

## Candidate Generation

| Metric | Dexter | Mew-X | Winner | Notes |
| --- | --- | --- | --- | --- |
| candidate_count | 114 | 0 | pending_live_evidence | Winner deferred until matched live packages are collected. |
...
| Metric | Dexter | Mew-X | Winner | Notes |
| --- | --- | --- | --- | --- |
| signal_to_attempt_latency_ms | unavailable | 888 ms | pending_live_evidence | Winner deferred until matched live packages are collected. |
...
| quote_vs_fill_slippage_bps | unavailable | 4.5031 bps | pending_live_evidence | Winner deferred until matched live packages are collected. |
...
| time_to_peak_ms | unavailable | 10 ms | pending_live_evidence | Winner deferred until matched live packages are collected. |
| realized_exit_pct | unavailable | 0 pct | pending_live_evidence | Winner deferred until matched live packages are collected. |
| realized_vs_peak_gap_pct | unavailable | -0.045 pct | pending_live_evidence | Winner deferred until matched live packages are collected. |
...
| --- | --- | --- | --- |
| Candidate edge | candidate_count=114; candidate_precision_proxy=0 (0.00%) | candidate_count=0; candidate_precision_proxy=unavailable | Validate sourcing deltas on matched live windows before naming a winner. |
| Execution substrate | signal_to_attempt=unavailable; fill_success_rate=unavailable | signal_to_attempt=888 ms; fill_success_rate=1 (100.00%) | Pair latency and slippage with the same market window before carrying any component forward. |
