...
| candidate_precision_proxy | 0.0157 (1.57%) | unavailable | pending | Metric unavailable for one or both sources. |
...
| attempt_to_fill_latency_ms | 502.5 ms | 1.5 ms | mewx | Lower value is treated as better. |
...
| Metric | Dexter | Mew-X | Winner | Notes |
| --- | --- | --- | --- | --- |
| max_favorable_excursion_pct | 34.8443 pct | 6.7929 pct | dexter | Higher value is treated as better. |
| max_adverse_excursion_pct | -6.0547 pct | 0 pct | mewx | Values closer to zero are treated as better drawdown outcomes. |
| time_to_peak_ms | 5299 ms | 20.5 ms | mewx | Lower value is treated as better. |
| realized_exit_pct | 7.1641 pct | 0 pct | dexter | Higher value is treated as better. |
| realized_vs_peak_gap_pct | 25.8042 pct | 0 pct | mewx | Lower value is treated as better. |
| stale_position_ratio | 0 (0.00%) | 1 (100.00%) | dexter | Lower value is treated as better. |
