...
- Accepted attestation refresh from merged PR `#107` as the bounded baseline current source of truth.
    ...
    context_pack["evidence"]["github_latest"].update(
        {
            ...
            f"vexter_pr_{VERIFIED_VEXTER_PR}_merged_at": VERIFIED_VEXTER_MERGED_AT,
            f"vexter_pr_{VERIFIED_VEXTER_PR}_closed_at": VERIFIED_VEXTER_MERGED_AT,
        }
    )
