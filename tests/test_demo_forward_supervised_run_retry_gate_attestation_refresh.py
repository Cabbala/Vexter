...
def test_demo_forward_supervised_run_retry_gate_attestation_refresh_artifacts_are_current_and_consistent() -> None:
    ...
    assert context["evidence"]["github_latest"]["latest_recent_vexter_prs"] == [98, 97, 96, 95, 93]
    assert (
        context["evidence"]["github_latest"]["vexter_pr_98_merged_at"]
        == "2026-03-28T14:03:19Z"
    )
