...
def test_demo_forward_supervised_run_retry_gate_attestation_refresh_artifacts_are_current_and_consistent() -> None:
    ...
    assert proof["verified_github"]["latest_vexter_pr"] == 95
    assert (
        proof["verified_github"]["latest_vexter_main_commit"]
        == "6f9c6053ef6e9509fa65b57866c956363fde50f3"
    )
    assert proof["verified_github"]["latest_vexter_merged_at"] == "2026-03-27T23:26:51Z"
    ...
    assert context["evidence"]["github_latest"]["latest_recent_vexter_prs"] == [95, 93, 92, 91, 90]
    assert (
        context["evidence"]["github_latest"]["vexter_pr_95_merged_at"]
        == "2026-03-27T23:26:51Z"
    )
